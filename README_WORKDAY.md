# Closed-ATS employers — set a manual job alert on each

Major Boston-area (and a few large remote-friendly) employers that hire
designers but run on Workday or their own systems, with no public API the
...
## Robotics / hardware
- [Teradyne](https://careers.teradyne.com) (North Reading)
...
- [Boston University](https://jobs.silkroad.com/BU/External)
