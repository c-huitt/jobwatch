...
designers but run on Workday or their own systems, which have no public API the
`jobwatch.py` script can query. Open each careers site, search "designer" or
...
(Amwell now has a public board and is tracked automatically in `jobwatch.py`.)
...
- [Genuine (Boston digital agency)](https://www.google.com/search?q=Genuine+Boston+digital+agency+careers)
- [Upstatement (small Boston studio)](https://upstatement.com)
...
closed, or on Workday / another system the script cannot query.
...
## Boston-office employers found in expansion (Workday / closed)
...
[Built In Boston](https://www.builtinboston.com/jobs) and on
[Wellfound](https://wellfound.com/jobs) for "product designer" + Boston/Remote.
They aggregate many of the smaller startups not worth tracking individually.
